...
public class display_l extends JFrame implements ActionListener {
    ...
    public display_l(){
        ...
        String[] columnNames = {"L_ID","L_NAME","L_DESCRIPTION","L_COST"};
    ...
    private void disp1() {
        ...
        try {
            ResultSet resultSet = stm.executeQuery("SELECT * FROM lights");
            while (resultSet.next()) {
                ...
                double price = resultSet.getDouble("L_COST");
