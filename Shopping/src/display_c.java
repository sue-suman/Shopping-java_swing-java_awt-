...
public class display_c extends JFrame implements ActionListener {
    ...
    public display_c(){
        ...
        String[] columnNames = {"C_ID","C_NAME","C_DESCRIPTION","C_COST"};
    ...
    private void disp1() {
        ...
        try {
            ResultSet resultSet = stm.executeQuery("SELECT * FROM camera");
            while (resultSet.next()) {
                ...
                double price = resultSet.getDouble("C_COST");
